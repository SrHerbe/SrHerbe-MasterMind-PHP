...
<head>
    ...
    <link rel="stylesheet" href="./css/partidaEnCurso.css">
...
<body>
    ...
    <section class="centrado partida_curso">
        <div class="partida_curso_contenedor">
            <h1>PARTIDA EN CURSO</h1>
            <div id="botones">
                <a id="continuar" href="jugar.php?dificultad=<?php echo $_SESSION["partida"]->dificultad; ?>">Continuar</a>
                <a id="salir" href="salirpartida.php">Salir</a>
            </div>
        </div>
    </section>
